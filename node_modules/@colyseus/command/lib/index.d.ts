...
export declare abstract class Command<State = any, Payload = unknown> {
    ...
    abstract execute(payload: this['payload']): Array<Command> | void | Promise<Array<Command>> | Promise<unknown>;
    /**
